...
export class ChartDisplayComponent implements OnInit {
    ...
    constructor(private ChartDisplayService: ChartDisplayService, private historicService : HistoricService) { }

    ngOnInit() {
        //this.getRamPercent();
        // this.getCpuPercent();
        // this.getPower();
        this.historicService.StartDate.subscribe(message => this.startTimestamp = message);
        this.historicService.EndDate.subscribe(message => this.endTimestamp = message);
        console.log("timestamps"+this.endTimestamp+"start"+this.startTimestamp)
        this.ChartDisplayService.putTimestamps(this.startTimestamp,this.endTimestamp);
        this.historicService.currentHostname.subscribe(message => this.hostname = message);
        this.ChartDisplayService.putHostname(this.hostname);
